...
class Task:
    ...
    def assign_member(self, member):
        if member in self.project.members: # if member exists, assign to task
            self.member = member
            print(f"{self.member} has been assigned to the task.") 
        else:
            print(f"{member} is not a member of the project. Please add them to the project first.")
...
class Project:
    ...
    def add_members(self, member):
        self.members.append(member) #manually able to add a member to a given project
